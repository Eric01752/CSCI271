...
public class Tree< T extends Comparable< T > >
{
   ...
   //recursive method for node count
   ...
   } // end method nodeCountHelper

   // method for leaves count
   public int leavesCount()
   { 
       return leavesCountHelper(root);
   }

   //recursive method for leaves count
   ...
   { 
       if(node == null){
           ...
           return leavesCountHelper(node.leftNode) + leavesCountHelper(node.rightNode);
       }
   }
